                ...
                <div className="container">
                    <div className={s.wrap}>
                        <div className={s.content}>
                            <img src="/meet-1.png" alt="img" loading="lazy" decoding="async" />
                        ...
                        <div className={s.box}>
                            ...
                            {/* <img src="/meet-2.png" alt="img" loading="lazy" decoding="async" /> */}
                            <img src="/meet-2.png" alt="img" loading="lazy" decoding="async" />
                            <img src="/meet-china.svg" alt="img" loading="lazy" decoding="async" />
                        </div>
                    </div>
                </div>
            </section>
